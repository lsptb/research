...
%                 end
      ...
      if c == length(parms.conditions)
        ...
        if strcmp(parms.showlabels,'yes')
          title(strrep(chanLabels{k},'_','\_'),'FontSize',parms.fontsize,'VerticalAlignment','baseline','Clipping','off','FontWeight',parms.fontweight,'Color',parms.fontcolor)
        end
        % Box
        ...
        % Colorbar
        if parms.autoscale && isequal(parms.colorbar,'yes')
