...
%     {default: 0}
%  'post_notch_flag' - [1|0] Toggle notch fft filter after averaging
%     {default: 0}
...
%  'write_log_flag' - [0|1] whether to write data extraction log text file
%
...
% last mod: 04/17/10 by Don Hagler
%
  ...
  if exist(matfile,'file')  && ~parms.forceflag
    ...
    if ~isempty(evnts)
      ...
      tags = {'prestim_dur','poststim_dur','baseline_flag',...
        ...
        'write_log_flag', 'rootoutdir','prefix'}; %SK
