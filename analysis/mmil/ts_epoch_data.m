...
% evntfile:
%   txt (events_fnames), ev2, evt (BESA)
% trigchan:
...
% Last mod: 23-Feb-2011, Jason Sherfey
...
if parms.write_events_file && exist('samp','var')
  ...
  function write_log
    ...
    if ischar(parms.datafile)
      [fpath,fname,ftype] = fileparts(parms.datafile);
      name = [name '_' fname];
    end
    name = [name '_events.txt'];
