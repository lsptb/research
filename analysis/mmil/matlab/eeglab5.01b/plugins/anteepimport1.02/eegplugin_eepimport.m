...
function vers = eegplugin_eepimport(fig, trystrs, catchstrs)
    ...
    % menu callbacks
    % --------------
    comcnt = [ trystrs.no_check '[EEGTMP LASTCOM] = pop_loadeep;' catchstrs.new_non_empty ];
    comavr = [ trystrs.no_check '[EEGTMP LASTCOM] = pop_loadeep_avg;' catchstrs.new_non_empty ];
