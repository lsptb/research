% ts_browseraw() - browse raw data
%
% ts_browseraw is a raw data browser with support for Neuromag fif format
%
% Usage: 
...
if ~ismember(datafile,callbacks)
  ...
  parms = mmil_args2parms(varargin, {...
    ...
    'showlabels',false,sort([false true]),...
    'xgrid',false,sort([false true]),...
    'ygrid',false,sort([false true]),...
    'color',false,sort([false true]),...
    'submean',false,sort([false true]),...
    'scale',true,sort([false true]),...
    'readevents',false,sort([false true]),...
    'events',[],[],...
    'hdr',[],[],...
    'ploteventdur',true,sort([false true]),...
    'minchan',0,[0 Inf],...
    'maxchan',Inf,[0 Inf],...
    'badchans',[],[],...
    'badchanfile',[],[],...
    ...
    'prereadeof',false,sort([false true]),...
    'read_mag',true,sort([false true]),...
    'read_grad1',true,sort([false true]),...
    'read_grad2',true,sort([false true]),...
    'read_eeg',true,sort([false true]),...
    'read_eog',true,sort([false true]),...
    'read_other',true,sort([false true]),...
    'scale_mag',0.5,[],...
    'scale_grad',1,[],...
    'scale_eeg',5,[],...
    'scale_eog',5,[],...
    'autoreject',true,sort([false true]),...
    'reject_mag',6000,[],...
    'reject_grad',3000,[],...
    'reject_eeg',0,[],...
    'reject_eog',200,[],...
    'prestim_dur',100,[],...
    'poststim_dur',300,[],...
    'filter',true,sort([false true]),...
    'filter_low_cf',0.2,[],...
    'filter_low_tb',0,[],...
    'filter_high_cf',100,[],...
    'filter_high_tb',0,[],...
    'dsfact',1,[1 1000],...
    'report_progress',false,sort([false true]),...
 });
  ...
  ui_timestep    = [0.30,0.0];
  ui_scaling     = [0.70,0.3];
  ui_value       = [0.83,0.0];
  ui_downsamp    = [0.70,0.2];
  ui_filter      = [0.83,0.13];
...
%% todo: take into account dsfact
 ...
 %        or different but simultaneous events?
  ...
  case 'filterdata'
    ...
    data = ts_freq_filt(tmp_data,parms.hdr.sfreq,[parms.filter_low_cf,parms.filter_high_cf],...
