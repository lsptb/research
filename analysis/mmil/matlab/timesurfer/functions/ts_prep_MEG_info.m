...
%
% note: minimally necessary information is "sensor_info" field of avg_data
%       structure, which is returned by ts_avg_fif_data
%
% Output:
%   MEG 306 coil information in NORMAL FORMAT
%   note: coordinates are returned in "head" space
%
%   MEG_info.Coil: 1 by 306 structure. 
...
for i=1:avg_data.num_sensors;
  ...
  if strcmp(upper(avg_data.sensor_info(i).label(1:3)),'MEG')==1,     % now MEG coils
    ...
    elseif avg_data.sensor_info(i).type==6001, % axial grad on KIT
        % this section was added by Andrei - June 25, 2009
        Coil(i).n=2;
    ...
    elseif avg_data.sensor_info(i).type==3024, 
        ...
        Coil_loc_tmp=[(Rcenter+[5.25 5.25 0.3]*[Ux;Uy;Uz]/1000);... 
                     ...
                     (Rcenter+[-5.25 -5.25 0.3]*[Ux;Uy;Uz]/1000);];
        Coil_loc_tmp=T_device_head*[Coil_loc_tmp';[1 1 1 1]];
        Coil(i).ori=[Uz;Uz;Uz;Uz];	% directions 
