...
outfile = sprintf('%s/s2_cluster-peaks_post-rejection_test1.mat',outpath); % peaks, events, flipvec, flipref, pij, rij, Ri, Eik, clusterstatus, InvolvedChans
save(outfile,'events','peaks','flipvec','flipref','pij','rij','Ri','Eik','clusterstatus','InvolvedChans');

% visualize flipped data matrix w/ SO clusters for selected intervals
visualizer(flipdat); % load interval-constrained peak clusters w/ new codes & rejection
