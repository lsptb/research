...
load('s1_SO_flip_matrix_filt0.01-4Hz_toi500-2700_grad1grad2_refall_smooth0.05sec_zero2zero0.25-1sec_mindist0.5sec_derivpks_22-Jun-2010.mat','flip');
[goodchans,jnk] = match_str({flip(1).sensor_info.label},{peaks.label});
