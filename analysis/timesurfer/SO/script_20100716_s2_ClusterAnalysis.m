...
% %     condition(c).comparison(s).SPLV_xROI_cmbavg = single([]);
    ...
    for k = 1:ncmb
      ...
      for n = 1:ntrials
        ...
        for f = 1:nfreq
          ...
          tix = [ii:(ntime-ii-1)];
          splv(1,tix,f,n) = abs(tmp / w);
          clear tmp
        end % end freq (f)
        Cs = Cs + splv(1,:,:,n)/ntrials;
        clear dat phi1 phi2 theta
      end % end trial (n)
      clear splv
      Bs = Bs + Cs / ncmb;
      Bw = Bw + Cs * ntrials;
...
save('script_20100717_s2_SPLV_SO_test2_RFvsRF.mat','condition');
...
avg = ts_freqanalysis_fieldtrip(ts_matrix2epoch(rand(4,100)),'foi',foi,'sf',sf,'trials_flag',1,'save_flag',0,'verbose',0);
% avg.num_sensors = 4;
% [avg.sensor_info(1:4)] = deal(avg.sensor_info);
...
% avg.num_sensors = 8;
% [avg.sensor_info(1:8)] = deal(avg.sensor_info);
% [avg.sensor_info(1:8).label] = deal('c1s1','c1s2','c1w1','c1w2','c2s1','c2s2','c2w1','c2w2');
% pp = cat(3, condition(1).comparison(1).SPLV_chancmbs_average_straight,...
%             condition(1).comparison(2).SPLV_chancmbs_average_straight,...
%             condition(1).comparison(1).SPLV_chancmbs_average_weighted,...
%             condition(1).comparison(2).SPLV_chancmbs_average_weighted,...
%             condition(2).comparison(1).SPLV_chancmbs_average_straight,...
%             condition(2).comparison(2).SPLV_chancmbs_average_straight,...
%             condition(2).comparison(1).SPLV_chancmbs_average_weighted,...
%             condition(2).comparison(2).SPLV_chancmbs_average_weighted);
% pp = cat(3, condition(1).comparison(1).channelpairs(1).SPLV_trial_average_straight,...
%             condition(1).comparison(1).channelpairs(2).SPLV_trial_average_straight,...
%             condition(1).comparison(1).channelpairs(3).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(1).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(2).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(3).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(4).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(5).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(6).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(7).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(8).SPLV_trial_average_straight,...
%             condition(1).comparison(2).channelpairs(9).SPLV_trial_average_straight,...
%             condition(2).comparison(1).channelpairs(1).SPLV_trial_average_straight,...
%             condition(2).comparison(1).channelpairs(2).SPLV_trial_average_straight,...
%             condition(2).comparison(1).channelpairs(3).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(1).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(2).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(3).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(4).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(5).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(6).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(7).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(8).SPLV_trial_average_straight,...
%             condition(2).comparison(2).channelpairs(9).SPLV_trial_average_straight);
% avg.num_sensors = size(pp,3);
% [avg.sensor_info(1:size(pp,3))] = deal(avg.sensor_info);
% [avg.sensor_info(1:size(pp,3)).label] = deal(...
%   'c1s1p1','c1s1p2','c1s1p3','c1s2p1','c1s2p2','c1s2p3','c1s2p4','c1s2p5','c1s2p6','c1s2p7','c1s2p8','c1s2p9',...
%   'c2s1p1','c2s1p2','c2s1p3','c2s2p1','c2s2p2','c2s2p3','c2s2p4','c2s2p5','c2s2p6','c2s2p7','c2s2p8','c2s2p9'); 
pp    = [];
ll    = {};
...
avg.timefreq        = rmfield(avg.timefreq,'cmplx');
avg.sfreq           = Fs;
