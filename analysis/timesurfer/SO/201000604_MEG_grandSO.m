...
%% 03-Jun-2010. Manual flipping and grand SO.
  ...
  outfile = sprintf('%s/s8_SOpeaks_filt%g-%gHz_toi%g-%g_%s_ref%s_ampstdfact%g_minzero%gms_monothresh%gHz.mat',outpath,parms.fc1,parms.fc2,toilim,grads{gradtype},'all',parms.amp_stdfact,parms.minzero,parms.monothresh);
  save(outfile,'events','peaks');
...
%     events = tmp;
    ...
    % Euclidean distance
    cfg.layout =[];
    cfg.layout = '/space/mdeh1/10/halgdev/projects/jsherfey/sleep/vv_planar.lay';
