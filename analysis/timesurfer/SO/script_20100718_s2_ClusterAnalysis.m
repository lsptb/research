  ...
  for s  = 1:length(comparisons)
    ...
    for k = 1:ncmb
      ...
      for n = 1:ntrials
        ...
        % find index into cluster TFR for ch1's trial n detection time
        % ...
        % ... alternative: avg wrt midpoint b/w ch1 & ch2 detection times
        % prepare data selection array and account for integration windows
        % extending outside the TFR limits
        % ...
        ...
        for f = 1:nfreq
          ...
          tix = [ii:(ntime-ii-1)];
          % account for offset relative to HistTime
          % ... this corresponds to a modification of tix
          % ...
...
save('script_20100717_s2_SPLV_SO_test2_LFvsLB.mat','condition');
...
% select individual sensors for tests
