...
% 
% MMIL revision 1 2009/02/24 10:21 AM - A Irimia
% changed calculation of var to handle the case where dof = 1
% 
...
if dof > 1, var = (ss - (s.^2)./dof) ./ (dof-1); else var = (ss - (s.^2)./dof) ./ dof; end  % changed by AI - 2009-02-24 to handle case dof = 1
