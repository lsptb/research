...
%
% Created:  01/20/2008 by Don Hagler
% Last Mod: 01/20/2008 by Don Hagler
%
...
% subsample surface
[subsurf.faces,subsurf.coords]=reducepatch(surf.faces,surf.coords,subfact);
subsurf.nverts = size(subsurf.coords,1);
...
for k=1:surf.nverts
  v = surf.coords(k,:);
  tmp = sum(abs(subsurf.coords - ones(subsurf.nverts,1)*v),2);
