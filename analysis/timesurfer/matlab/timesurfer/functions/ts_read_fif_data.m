...
% ts_read_fif_data reads raw data from Neuromag fif files
%
% Usage:
%   [data,eofstatus] = ts_read_fif_data(datafile, hdr, begsample, endsample, chanindx);
% where hdr is obtained using READ_FIF_HEADER.
%
