...
if isfield(cfg, 'hdmfile')
  ...
  switch(filetype(cfg.hdmfile))
    ...
    case 'neuromag_fif'
      ...
      [vol.bnd.pnt, vol.bnd.tri, normals] = loadtri(vol.filename);
...
if isfield(cfg, 'gradfile')
  ...
  grad = read_fcdc_elec(cfg.gradfile);
...
% do postprocessing of the gradiometers
if exist('grad', 'var')
...
if exist('elec', 'var')
  sens = elec;
  sens.type = 'electrodes';
elseif exist('grad', 'var')
  sens = grad;
  sens.type = 'gradiometers';
else
