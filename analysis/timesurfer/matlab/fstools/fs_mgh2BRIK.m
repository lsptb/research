function mgh2BRIK(fname_in,fname_out,frames,out_orient,forceflag)
%function mgh2BRIK(fname_in,[fname_out],[frames],[out_orient],[forceflag])
%
% Required Input:
...
[fpath,fstem,fext,ver] = fileparts(fname_in);
...
%cmd = sprintf('3dcopy %s %s',niftifile,fname_out);
[status,msg] = unix(cmd);
