...
%
% Created:
%    08/20/2007 - Rajan Patel
% Last Modified:
%    09/16/2008 - Jason Sherfey
%
% See also: ts_recode_events
%% Check Inputs ect
%  TO DO: change the options input to the mmil_args2parms.
        ...
        while (isempty(tmp))
            switch (iRule)
                ...
                case 1
                    ...
                    if (~isempty(tmp))
                        cur_rule.conditions = double(cell2num(splitstr(tmp{1}{1},',')));
                        if j==1
                ...
                case 3
                    ...
                    if (~isempty(tmp))
                        cur_rule.conditions = cell2num(splitstr(tmp{1}{3:end},','));
                        cur_rule.mode = 'relative';
                        cur_rule.method = @match_by_epoch;
                        cur_rule.epoch = [str2double(tmp{1}{1}) str2double(tmp{1}{2})];
                    end;
